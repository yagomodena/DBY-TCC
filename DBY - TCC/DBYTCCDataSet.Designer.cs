...
namespace DBY___TCC {
    ...
    public partial class DBYTCCDataSet : global::System.Data.DataSet {
        ...
        public partial class tbUsuariosDataTable : global::System.Data.TypedTableBase<tbUsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tbUsuariosRow AddtbUsuariosRow(string USUARIO, string SENHA) {
...
namespace DBY___TCC.DBYTCCDataSetTableAdapters {
    ...
    public partial class tbUsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tbUsuarios] WHERE (([ID] = @Original_ID) AND ([USUARIO] = @Ori" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbUsuarios] ([USUARIO], [SENHA]) VALUES (@USUARIO, @SENHA);\r\nS" +
                "ELECT ID, USUARIO, SENHA FROM tbUsuarios WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tbUsuarios] SET [USUARIO] = @USUARIO, [SENHA] = @SENHA WHERE (([ID]" +
                " = @Original_ID) AND ([USUARIO] = @Original_USUARIO) AND ([SENHA] = @Original_SE" +
                "NHA));\r\nSELECT ID, USUARIO, SENHA FROM tbUsuarios WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, USUARIO, SENHA FROM dbo.tbUsuarios";
        ...
        public virtual int Fill(DBYTCCDataSet.tbUsuariosDataTable dataTable) {
        ...
        public virtual DBYTCCDataSet.tbUsuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DBYTCCDataSet.tbUsuariosDataTable dataTable = new DBYTCCDataSet.tbUsuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBYTCCDataSet.tbUsuariosDataTable dataTable) {
